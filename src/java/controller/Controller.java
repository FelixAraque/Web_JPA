...
public class Controller extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (op.equals("inicio")) {
            ...
            provinciaSelected = provincias.get(Integer.parseInt(cbprovincia));
            ...
            municipioSelected = municipios.get(Integer.parseInt(cbmunicipio));
            ...
            String posplaya = request.getParameter("playa");
            playas = (List<Playa>) session.getAttribute("playas");
            playa = playas.get(Integer.parseInt(posplaya));
